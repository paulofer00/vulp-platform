...
export default function FoxAnimation() {
  return (
    // Ajuste de posicionamento para ocupar a altura total e não cortar
    <div className="fixed top-0 -left-[15vh] h-screen w-auto aspect-[4/5] z-0 pointer-events-none hidden lg:block overflow-visible opacity-70">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 100 100"
        // Garante que o SVG tente preencher o espaço sem distorcer ou cortar
        preserveAspectRatio="xMidYMid meet"
        className="w-full h-full"
        style={{
            // Neon Roxo SUPER Intenso (Múltiplas camadas de brilho)
            filter: `
                drop-shadow(0 0 1px #fff)
                drop-shadow(0 0 3px #d8b4fe) 
                drop-shadow(0 0 10px #a855f7)
                drop-shadow(0 0 20px #7e22ce)
            `
        }}
      >
        <style>{`
          .st0 {
            fill: none;
            stroke: #f3e8ff; /* Roxo quase branco para o núcleo do neon */
            stroke-width: 0.6px; /* Traço mais grosso */
            stroke-linecap: round;
            stroke-linejoin: round;
          }

          /* Animação APENAS de Rotação do Rabo */
          @keyframes tailWag {
            0%, 100% { transform: rotate(-3deg); }
            50% { transform: rotate(6deg); }
          }

          /* O grupo todo fica parado */
          .fox-group {
             /* Sem animação de flutuar aqui */
          }

          /* Apenas o corpo (onde está o rabo) anima */
          .body-tail {
            /* Pivô ajustado para a base do pescoço, para o rabo balançar */
            transform-origin: 50% 40%;
            animation: tailWag 5s ease-in-out infinite;
          }
        `}</style>

        <g className="fox-group">
            {/* PATH 1 - Cabeça (Totalmente ESTÁTICO) */}
            <path
                className="st0"
