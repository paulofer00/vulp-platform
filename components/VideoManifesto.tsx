...
export default function VideoManifesto() {
  ...
  return (
    // O componente agora é modular, sem espaçamentos gigantes por fora
              ...
              <div className="flex-1 flex items-end">
                  <div className="w-full px-6 pb-6">
                      ...
                      >
                          ...
                          >
                              {/* 👇 RAPOSA DA VULP SEMPRE VISÍVEL E MAIOR 👇 */}
                              <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 flex items-center justify-center transition-all duration-300">
                                  {/* Mudei de w-6 h-6 para w-8 h-8 (se quiser ainda maior, mude para w-10 h-10) */}
