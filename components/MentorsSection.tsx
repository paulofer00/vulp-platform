...
// Montando o SVG Data URI
// Usei viewBox='0 0 1920 1080' e stroke-width='10'
...
export function MentorsSection() {
  ...
  return (
    <section className="py-32 px-6 relative z-10 bg-white text-gray-900 overflow-hidden">
      ...
      {/* --- BACKGROUND PATTERN RAPOSA NEON (ORGANIZADO) --- */}
      <div className="absolute inset-0 z-0 pointer-events-none">
         <div 
            className="absolute inset-0" 
            style={{
                backgroundImage: `url("${foxPatternSVG}")`,
                // backgroundSize controla o tamanho de cada "azulejo" da raposa.
                // 180px deixa elas pequenas e organizadas.
                backgroundSize: '180px auto', 
                backgroundPosition: 'center',
                backgroundRepeat: 'repeat', // Garante a repetição organizada
            }}
         />
         {/* Luz suave branca para integrar */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            ...
            <div className="order-2 lg:order-1">
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-8 border-l-4 border-purple-500 pl-6">
                    ...
                    Na VULP, seus mentores não são teóricos de palco. São profissionais que lideram equipes, fecham contratos reais e vivem o que ensinam.
                </p>
        ...
        <div className="border-t border-gray-200 pt-16 relative">
            ...
            <div className="flex flex-wrap justify-center gap-6 opacity-60 hover:opacity-100 transition-opacity duration-500">
                {[1, 2, 3, 4, 5].map((_, i) => (
                    <div key={i} className="w-32 h-32 bg-gray-100 rounded-2xl flex items-center justify-center border border-gray-200 grayscale hover:grayscale-0 hover:border-purple-500/50 transition-all duration-300 group hover:-translate-y-1">
                            <div className="w-12 h-12 bg-gray-300 rounded-lg group-hover:bg-purple-500/30 transition-colors" />
                    </div>
                ))}
            </div>
        </div>
