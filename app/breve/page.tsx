...
// =========================================================
// PARTE 1: WEBGL (Fundo Líquido - Mantido Igual)
// =========================================================
...
// =========================================================
// PARTE 2: PÁGINA COM PRELOADER E NEON
// =========================================================
...
const VulpMergedPage = () => {
  ...
  useEffect(() => {
    // Timer para remover o loading após 2.5 segundos
  ...
  return (
    <div ref={containerRef} className="h-[300vh] bg-[#050505] relative font-sans selection:bg-purple-600">
            ...
            >
                <div className="w-24 h-24 md:w-32 md:h-32">
                    <svg viewBox="0 0 100 100" className="w-full h-full overflow-visible">
                        ...
                        {/* Grupo com as duas partes do logo */}
                        <motion.g
                            fill="transparent"
                        ...
                        >
                             <motion.path
                                ...
                                animate={{ pathLength: [0, 1, 0] }} // Desenha e Des-desenha
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        {/* --- TEXTO INICIAL COM EFEITO NEON PULSANTE --- */}
        <motion.div 
            style={{ opacity: textOpacity, scale: textScale }}
            className="absolute inset-0 z-10 flex flex-col items-center justify-center pointer-events-none"
        >
            <motion.h1 
                // ANIMAÇÃO DE NEON PULSANDO
                animate={{ 
                    textShadow: [
                        "0 0 20px rgba(147, 51, 234, 0.4)", // Estado inicial (fraco)
                        "0